...
<html>
<head>
  <link href="${path}/css/applicationFormList.css?ver=2" rel="stylesheet" type="text/css" />
  <title>게시판</title>
</head>
<body>
  <div id="root">
        ...
        <table>
          ...
          <c:forEach items="${list}" var="list">
            <tr>
              ...
              <td><a href="/updateView?fno=${list.fno}"><c:out value="${list.festivalName}" /></a></td>
             ...
             <!--  <td><c:out value="${list.place}" /></td> -->
              ...
              <td><a href="/updateView?fno=${list.fno}">수정</a></td>
